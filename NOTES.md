...
- Enchanted Forest
  - Center of map and locked/gated until later in game
  - Mystic Pond
  - Ancient Tree
...
- Lasso for pulling levers or swinging across gaps
  - Get lasso from PE teacher after completing a quest for them
- Flute that calls animal friends to your side like cute kitties and puppies
...
- [Need to add more mini-bosses and casual enemies]
...
- TBD (Old man in town)
- TBD (kid in town)
- TODO: add all other NPCs for other towns/biomes
