...
This folder is the “how we work” playbook. It is written so you can:
- start a new agent session without re-reading chat history,
- keep decisions centralized in `spec.md`,
- and ship incrementally with reliable automated playtests.
