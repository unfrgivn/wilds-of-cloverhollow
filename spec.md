...
- Café (Interior): Cozy café interior with warm wooden floor. Counter with cash register, glass display case with pastries, 3 tables with chairs. Kitchen visible through doorway at back. Menu board on wall. Welcome sign with café greeting. Transition back to Town Center.
